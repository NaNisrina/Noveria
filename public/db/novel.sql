...
--
-- Indexes for table `isi_cerita`
--
ALTER TABLE `isi_cerita`
  ADD PRIMARY KEY (`id_isi_cerita`);
...
--
-- AUTO_INCREMENT for table `isi_cerita`
--
ALTER TABLE `isi_cerita`
  MODIFY `id_isi_cerita` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
